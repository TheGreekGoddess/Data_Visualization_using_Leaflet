...
d3.json(earthquakesURL, function(earthquakeData) {
    ...
    // Grab data from the Tectonic Plates GeoJSON Data using D3
    d3.json(tectonicPlatesURL, function(plateData) {

        // Define a GeoJSON layer containing the tectonic plates data
        L.geoJson(plateData, {
            color: "#DB2E27",
            weight: 2.9

        // Add the tectonic plates data to tectonic plates layer group
        }).addTo(tectonicPlates);

        // Add the tectonic plates layer to the displayed map
